...
DEPENDENCIES:
  ...
  - intent_engine/src/database.py  : reads/writes company_contacts
...
DOMAIN KNOWLEDGE:
  Apollo confidence scores (intent_signals.confidence):
