...
from intent_engine.src.data_quality import run_dqe_on_company, run_dqe_on_contact
...
HS_COMPANY_FIELDS = [
    ...
    {"key": "oracle_cloud_solutions",     "label": "Detected Products (Cloud)",      "required": False},
    {"key": "oracle_on_premise_solutions","label": "Detected Products (On-Premise)", "required": False},
    {"key": "oracle_relationship_type",   "label": "Vendor Relationship Type",       "required": False},
    {"key": "oracle_support_end_date",    "label": "Support End Date",               "required": False},
    {"key": "oracle_version",             "label": "Product Version",                "required": False},
    {"key": "number_of_oracle_users",     "label": "Number of Product Users",        "required": False},
    {"key": "location",                   "label": "Location",                       "required": False},
    {"key": "size",                       "label": "Size / Revenue Band",            "required": False},
    {"key": "target_product",             "label": "Target Product",                 "required": False},
    {"key": "campaign_name",              "label": "Signal Campaign",                "required": False},
]
...
HS_CONTACT_FIELDS = [
    ...
    {"key": "product_alignment","label": "Product Alignment", "required": False},
    {"key": "ready_for_outreach","label": "Ready for Outreach","required": False},
